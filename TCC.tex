...
Todo este processo, o qual pode ser chamado de Descoberta de Conhecimento em Base de Dados ou KDD \apudonline{fayyad1996kdd}{inproceedings}, está descrito na \autoref{fig_processo_descoberta}.
...
Ainda segundo \citeonline{camilo2009mineraccao}, até agora não é consesnso a definição dos termos \emph{Data Mining} e \emph{KDD}. No entanto, todos concordam que o processo de mineração deve ser interativo, iterativo e particionado em fases, comforme visto na \autoref{fig_processo_descoberta}. 
